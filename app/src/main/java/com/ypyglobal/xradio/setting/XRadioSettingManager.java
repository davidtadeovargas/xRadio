...
public class XRadioSettingManager implements IXRadioSettingConstants {
	...
	public static void setBackgroundUrl(Context mContext, String mValue){
	...
	public static void setStartColor(Context mContext, String mValue){
	...
	public static void setOrientation(Context mContext, int mValue){
	...
	public static void setEndColor(Context mContext, String mValue){
